...
class Recycle2Activity : AppCompatActivity() {
    ...
    class MyDecoration(val context: Context): RecyclerView.ItemDecoration() {
        override fun onDraw(c: Canvas, parent: RecyclerView, state: RecyclerView.State) {
            ...
            c.drawBitmap(BitmapFactory.decodeResource(context.getResources(), R.drawable.chunsick3), 0f,0f,null);
        }
        ...
        override fun onDrawOver(c: Canvas, parent: RecyclerView, state: RecyclerView.State) {
            ...
            //이미지 사이즈 계산
            val dr: Drawable? = ResourcesCompat.getDrawable(context.getResources(), R.drawable.chunsick, null)
            ...
            c.drawBitmap(
                BitmapFactory.decodeResource(context.getResources(), R.drawable.rupy),
                left.toFloat(),
                top.toFloat(),
                null
            )
