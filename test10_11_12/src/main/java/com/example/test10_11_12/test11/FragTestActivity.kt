...
class FragTestActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //프래그먼트 기본 테스트
        //방법1 ) xml 구성하는 방법, 코드로 구성하는 방법
        //test11/src/main/java/com/example/test11/MainActivity337.kt
        //출력방식이 액티비티에 name으로 해당 프래그먼트를 지정해서 출력
        //방법2 ) 액티비티 코드에서 해당 프래그먼트를 호출, 출력하는 방법
        //프래그먼트 또 만들기
        ...
        //백스텝을 설정 시 커밋 이전 함수에서 설정하면 됨
        //뒤로가기 버튼을 클릭시 해당 액티비티를 종료하는게 아니라 메모리상에 있는 프래그먼트 재사용
