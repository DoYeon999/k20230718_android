...
//변경사항
// 1 -> ActivityMainBinding -> ActivityMain6Binding
// 2  DatabaseHelper 일반 클래스 만들기
// 3 뷰 작업
// 4 AlertDialog 임포트 androidx 제트팩 라이브러리 추가
// 56번째줄 buttonDelete = findViewById(R.id.buttonDelete) 중복 삭제
class MainActivity : AppCompatActivity() {
    // 전역으로 선언만 했지, 할당을 안했음.
    // 그래서, onCreate 라는 함수에서 , 최초 1회 실행시.
    // 할당을 하는 구조.
    // 마치, DAO, Repository, Mybatis Mapper, JPA 엔티티클래스와 서비스
